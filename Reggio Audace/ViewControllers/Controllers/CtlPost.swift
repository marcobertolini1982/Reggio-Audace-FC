...
class CtlPost: CtlBase,ProSinglePostObs,ProFileObs,ProPostPollObs,UITableViewDelegate,UITableViewDataSource
{
    ...
    override func viewDidLoad()
    {
        ...
        let l_Tableview:UITableView = UITableView()
        l_Tableview.backgroundColor = GARNETCOLOR
        l_Tableview.translatesAutoresizingMaskIntoConstraints = false
        ...
        self.VIEPOST.bottomAnchor.constraint(equalTo: l_Tableview.topAnchor).isActive = true
